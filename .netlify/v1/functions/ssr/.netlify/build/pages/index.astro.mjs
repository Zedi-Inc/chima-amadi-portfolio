...
import 'kleur/colors';
import { r as $$Socials, $ as $$Container, d as $$BlogPostsList } from '../chunks/Logo_CQR-xznP.mjs';
import { b as articles, $ as $$Heading } from '../chunks/sanity-utils_D-G2s1on.mjs';
...
const $$HomeHeroSection = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Container", $$Container, { "data-astro-cid-ulkickqi": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="hero-section__section flex flex-col-reverse md:flex-row justify-between gap-10 px-4 lg:px-12 mt-8" data-astro-cid-ulkickqi> <div class="hero-section__text" data-aos="fade-right" data-astro-cid-ulkickqi> <h1 class="text-[44px] text-red-800 font-semibold text-center md:text-right md:text-[50px] lg:text-5xl -tracking-[4px] whitespace-nowrap" data-astro-cid-ulkickqi>
Dr. Chima Amadi
</h1> <div class="flex justify-center md:justify-end" data-astro-cid-ulkickqi> <p class="text-xs md:text-sm lg:text-sm text-center md:text-right max-w-[80%]" data-astro-cid-ulkickqi>
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Page, { "seo": seo, "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AOSInit", $$AOSInit, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "HomeHeroSection", $$HomeHeroSection, { "data-astro-cid-j7pv25f6": true })} ${maybeRenderHead()}<section class="pb-10 lg:px-6" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "SectionTop", $$SectionTop, { "data-astro-cid-j7pv25f6": true }, { "image-container": ($$result3) => renderTemplate`<picture data-aos="fade-right" data-astro-cid-j7pv25f6> <img src="/assets/images/home/chima-amadi-2.webp" alt="Dr. Chima Amadi's image" id="home-hero-image" data-astro-cid-j7pv25f6> </picture>`, "text-container": ($$result3) => renderTemplate`<div data-aos="fade-right" data-astro-cid-j7pv25f6> ${renderComponent($$result3, "Heading", $$Heading, { "data-astro-cid-j7pv25f6": true }, { "headingText": ($$result4) => renderTemplate`<h2 class="text-lg md:text-2xl font-medium tracking-[1px]" data-astro-cid-j7pv25f6>
About Dr. Chima Amadi
</h2>` })} <div class="text-xs md:text-sm" data-aos="fade-left" data-astro-cid-j7pv25f6> <p data-astro-cid-j7pv25f6>
